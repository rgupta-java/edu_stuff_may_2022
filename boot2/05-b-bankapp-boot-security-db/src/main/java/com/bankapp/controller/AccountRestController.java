...
//@PreAuthorize("hasAuthority('ROLE_MGR')")	//@PreAuthorize("hasRole('MGR')")
...
public class AccountRestController {
	...
	public ResponseEntity<List<Account>> getAllAccounts(@AuthenticationPrincipal SecUser secUser) {
		//now u can do ur business logic
		System.out.println("-------------------------------------------------");
