...
//@PreAuthorize("hasAuthority('ROLE_MGR') or hasAuthority('ROLE_CLERK')")// it allow more power and or .. negation....regex
//@PreAuthorize("hasRole('MGR') or hasRole('CLERK')")


//@PostAuthorize("returnObject.name==authentication.name")

//@Secured({"ROLE_MGR","ROLE_CLERK"})	//role must be mgr or clerk but there is no trick u can mention and
