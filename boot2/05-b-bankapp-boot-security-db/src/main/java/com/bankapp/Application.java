...
//		userService.addUser(new UserEntity("raj", "raj121", "raj@gmail.com", Arrays.asList("ROLE_MGR","ROLE_CLERK")));
//		userService.addUser(new UserEntity("ekta", "ekta121", "raj@gmail.com", Arrays.asList("ROLE_CLERK")));
//		
